...
def plot_boundary_conditions(coords, boundary_conditions, title, surface_level, ax=None, adiabatic_pairs=None):
    ...
    # print(f"Grid dimensions: Nx={coords.Nx}, Ny={coords.Ny}, Nz={coords.Nz}")
    # print(f"Region dimensions: Lx={coords.Lx:.3f}, Ly={coords.Ly:.3f}, Lz={coords.Lz:.3f}")
    # print(f"Element sizes: dx={coords.dx:.3f}, dy={coords.dy:.3f}, dz={coords.dz:.3f}")
    ...
    if adiabatic_pairs:
        print(f"Plotting {len(adiabatic_pairs)} adiabatic pairs")
